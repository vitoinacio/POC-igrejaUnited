...
export function LoginView() {
  ...
  return (
    <section className="page-shell min-h-screen grid place-items-center py-12 lg:py-20">
      <Card className="w-full max-w-md shadow-soft">
        ...
        <CardContent className="space-y-5">
          ...
          <p className="text-center text-sm text-muted-foreground">
            Não tem acesso? <a href="/" className="text-primary hover:underline font-medium">Volte para o site</a>
          </p>
        </CardContent>
      </Card>
    </section>
